...
export default function Projects({}: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="w-screen grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 snap-center">
        {projects.map((project) => (
          <motion.div
            ...
            className="w-[300px] h-[300px]
						items-center justify-center group flex flex-col relative overflow-y-scroll"
          >
            <SocialIcon
